...
namespace Wookie.Project.Contract
{
    class Category : Wookie.Menu.IAssemblyInstance, IDisposable
    {
        ...
        public XtraUserControl UserControl
        {
            get
            {
                if (this.control == null)
                    control = new Control.ucProjectContract(modulData);
                return control;
            }
        }
        ...
        public Image Image
        {
            get { return ((Control.ucProjectContract)this.UserControl).Image; }
            set { ((Control.ucProjectContract)this.UserControl).Image = value; }
        }
