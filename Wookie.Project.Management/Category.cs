...
namespace Wookie.Project.Management
{
    class Category : Wookie.Menu.IAssemblyInstance, IDisposable
    {
        ...
        public XtraUserControl UserControl
        {
            get
            {
                if (this.control == null)
                    control = new Control.ucProjectManagement(modulData);
                return control;
            }
        }
        ...
        public Image Image
        {
            get { return ((Control.ucProjectManagement)this.UserControl).Image; }
            set { ((Control.ucProjectManagement)this.UserControl).Image = value; }
        }
